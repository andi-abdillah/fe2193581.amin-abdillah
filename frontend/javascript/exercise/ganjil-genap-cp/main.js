...
function ganjilGenap(plat) {
  ...
  if(plat == ""){
    ...
    output = "plat genap sebanyak " + platGenap + " dan plat ganjil tidak ditemukan";
  }else if(platGenap === 0 && platGanjil > 0){
    output = "plat ganjil sebanyak " + platGanjil + " dan plat genap tidak ditemukan";
  }else if(platGanjil > 0 && platGenap > 0){
    output = "plat genap sebanyak " + platGenap + " dan plat ganjil sebanyak " + platGanjil;
  }else {
    output = "invalid data";
  }
  return output;
...
// ganjilGenap('2341;3429;864;1309;1276');
